...
// Consecutive hours developer codes
	private static final List<Integer> x = Arrays.asList(2, 3, 5, 7, 9, 11, 14); // Number of bugs produced
	private static final List<Integer> y = Arrays.asList(4, 5, 7, 10, 15, 20, 40);
